<%@ Page Language="C#" AutoEventWireup="true" CodeFile="~/SysPages/Index.aspx.cs" Inherits="SysPages_Index" %>
...
<frameset rows="64,*" frameborder="NO" border="0" framespacing="0">
  ...
  <frameset cols="200,*"  rows="760,*" id="frame">
	...
	<frame src="right.aspx" name="right" marginwidth="0" marginheight="0" frameborder="0" scrolling="auto" target="_self" />
  </frameset>
<noframes>
  <body></body>
    </noframes>
