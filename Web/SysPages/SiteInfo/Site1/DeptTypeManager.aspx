<%@ Page Language="C#" AutoEventWireup="true" CodeFile="~/SysPages/SiteInfo/DeptTypeManager.aspx.cs"
	Inherits="SysPages_SiteInfo_DeptTypeManager" %>
...
<head id="Head1" runat="server">
	...
	<script type="text/javascript" defer="defer">
		...
		function Refrash()
		{
			var pathname = "../Site1/DeptTypeManager.aspx";
		...
		<div class="right">
			<div class="right_dh">
				<div class="right_dh_wz">
					<a href="index.aspx" target="_parent">首页</a> &gt;&gt; 网站信息 &gt;&gt; 单位类型管理</div>
			</div>
		</div>
		<div>
								...
								<td>
									<table width="99%">
										...
										<asp:Repeater ID="repList" runat="server">
											<ItemTemplate>
												<tr name="trname" style="height: 25px; font-size: 12px; color: #333333; text-align: center">
													<td >
													...
													<img src="../../../Images/Img1/right_xg.png" onclick="ClickOp(<%#((Model.T_Dictionary)Container.DataItem).Id.ToString() %>)" />
														<asp:ImageButton ID="btnDel" Style="position: fixed" OnClientClick="return confirm('确定删除！')"
															CommandArgument="<%#((Model.T_Dictionary)Container.DataItem).Id.ToString() %>"
