...
<head runat="server">
	...
	<script type="text/javascript" defer="defer">
		...
		function Refrash()
		{
			var pathname = "../Site1/UserManager.aspx";
		...
		<div class="right">
			<div class="right_dh">
				<div class="right_dh_wz">
					<a href="index.aspx" target="_parent">首页</a> &gt;&gt; 用户信息 &gt;&gt; 用户管理</div>
			</div>
		</div>
		<div>
								...
								<ItemTemplate>
									<tr name="trname" style="height: 25px; font-size: 12px; color: #333333; text-align: center">
										...
										<td>
											...
											<asp:ImageButton ID="btnDel" OnClientClick="return confirm('确定删除！');" CommandArgument="<%#((Model.T_SysUser)Container.DataItem).Id.ToString() %>"
