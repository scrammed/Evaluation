...
<head id="Head1" runat="server">
	...
	<script type="text/javascript" defer="defer">
		...
		function Refrash()
		{
			var pathname = "../Site2/UserManager.aspx";
									...
									<asp:Repeater ID="repList" runat="server">
										...
										<ItemTemplate>
											<tr align="center">
												...
												<td style=" background-color: #ffffff">
													<img src="../../../Images/Img1/right_xg.png" onclick="ClickOp(<%#((Model.T_SysUser)Container.DataItem).Id.ToString() %>)" />
													<asp:ImageButton ID="btnDel" OnClientClick="return confirm('确定删除！');" CommandArgument="<%#((Model.T_SysUser)Container.DataItem).Id.ToString() %>" runat="server" ImageUrl="~/Images/Img1/right_sc.png" OnClick="btnDel_Click" Style="position: fixed" />
												</td>
											</tr>
										</ItemTemplate>
									</asp:Repeater>
